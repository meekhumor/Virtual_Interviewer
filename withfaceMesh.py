...
# Initialize Mediapipe Drawing Utilities (Added for Face Mesh Overlay)
mp_drawing = mp.solutions.drawing_utils  # Added
mp_drawing_styles = mp.solutions.drawing_styles  # Added
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            # ========= ADDED: Draw Face Mesh =========
            mp_drawing.draw_landmarks(
                frame,
                face_landmarks,
                mp_face_mesh.FACEMESH_TESSELATION,  # Draw full face mesh
                mp_drawing.DrawingSpec(color=(0, 255, 0), thickness=1, circle_radius=1),  # Green dots
                mp_drawing.DrawingSpec(color=(255, 0, 0), thickness=1, circle_radius=1)  # Blue lines
            )
            # =========================================
