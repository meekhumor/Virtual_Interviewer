...
export default function Resume() {
  return (
    <div className="mx-auto w-full max-w-xl flex flex-col gap-4 items-center bg-darkblue bg-opacity-40 py-14 my-16 rounded-3xl">
      ...
      <div className="flex gap-3 bg-darkblue bg-opacity-40 items-center py-4 px-4 rounded-xl">
      ...
      <Link to="/cam-permission" className="text-white py-2 rounded-3xl px-8  bg-blue1 hover:bg-darkblue mt-6">Next</Link>
    </div>
  );
}
