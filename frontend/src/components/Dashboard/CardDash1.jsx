...
function CardDash1({title , description, tagline, image, link}) {
  return (
    <div>
        <div className='bg-darkblue bg-opacity-40 rounded-3xl flex flex-col items-center w-64 h-96'>
          ...
          <Link to={link} className="bg-blue1 text-white hover:bg-darkblue rounded-3xl px-4 py-3 mb-8 text-sm">{tagline}</Link>
        </div>
    </div>
  )
}
